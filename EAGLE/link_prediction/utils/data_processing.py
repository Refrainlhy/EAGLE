...
# simplified for transductive setting
def get_data_transductive(dataset_name, use_validation=False):
    my_datasets = ["Contacts", "lastfm", "wikipedia", "reddit", "superuser", "askubuntu", "wikitalk"]
    bench_datasets = [
        "mooc",
        "enron",
        "SocialEvo",
    ...
    TGL_datasets = ["GDELT"]
    if dataset_name in my_datasets:
        dir = "data"
    elif dataset_name in bench_datasets:
