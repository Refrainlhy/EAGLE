...
best_time_score_filename = f'{DATA}_topk_{time_topk}_flag_{topk_sample_flag}_lr_{lr}_wd_{wd}_bs_{bs}'
...
test_ap = mix_scores('Test', test_data, bs, test_time_pos_score, test_time_neg_score, test_structure_score, test_delta_times_list, test_all_inds_list, 99, time_topk, yita=best_yita, device=device, k_list=k_list)
